<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Data Guru Menu -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo BASE_URL; ?>admin/data_guru.php">
            ...
            <li class="nav-item">
                ...
                <div id="collapseNilai" class="collapse" aria-labelledby="headingNilai" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="print_nilai.php">Print Nilai</a>
                    </div>
                </div>
            </li>
            ...
            <!-- <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Tabungan Siswa</h6>
            ...
            <li class="nav-item">
                ...
                <div id="collapseMasterData" class="collapse" aria-labelledby="headingMasterData" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="tahun_ajaran.php">Tahun Ajaran</a>
                        <a class="collapse-item" href="list_kelas.php">Kelas</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                                ...
                                <!-- <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div>
                                        <div class="small text-gray-500">12 Juli 2024</div>
                                ...
                                <!-- <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div>
                                        <div class="small text-gray-500">11 Juli 2024</div>
                                        Rp. 100.000 telah disetorkan ke akun Anda!
                                    </div>
                                </a> -->
                                <!-- <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="mr-3">
                                    ...
                                    <div>
                                        <div class="small text-gray-500">10 Juli 2024</div>
                                        Perbaharui sekarang
                                    </div>
                                </a> -->
                        ...
                        <!-- <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div class="font-weight-bold">
                                        <div class="text-truncate">Hai, Saya ingin tahu apakah Anda dapat membantu saya dengan masalah yang saya alami.</div>
                                        <div class="small text-gray-500">Asep · 30 Menit yang lalu</div>
                                    </div>
                                </a>
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                    ...
                                    <div>
                                        <div class="text-truncate">Saya punya foto yang Anda pesan bulan lalu, bagaimana caranya apakah Anda ingin dikirimkan kepada Anda?</div>
                                        <div class="small text-gray-500">Udin · 2 Jam yang lalu</div>
                                    </div>
                                </a>
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                    ...
                                    <div>
                                        <div class="text-truncate">Laporan bulan lalu terlihat bagus, saya sangat senang
                                            kemajuan sejauh ini, teruslah bekerja dengan baik!</div>
                                        <div class="small text-gray-500">Tatang · 21 Jam yang lalu</div>
                                    </div>
                                </a>
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                    ...
                                    <div>
                                        <div class="text-truncate">Apakah saya anak yang baik? Alasan saya bertanya adalah karena seseorang mengatakan kepada saya bahwa orang-orang mengatakan ini kepada semua anjing, meskipun mereka tidak baik...</div>
                                        <div class="small text-gray-500">Ujang · 1 Hari yang lalu</div>
                                    </div>
                                </a>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><b><?= $_SESSION["ssUser"] ?></b></span>
                                <img class="img-profile rounded-circle" src="../assets/img/icons8-user-default.png">
                            </a>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" id="modalLogout">Anda yakin untuk Keluar?</h1>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="../auth/logout.php" class="btn btn-sm btn-primary">Keluar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
