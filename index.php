...
<head>
    ...
    <title>TK Aisyiyah Bustanul Athfal labuan</title>
...
<body>
    ...
    <section id="topbar" class="d-flex align-items-center">
        <div class="container d-flex justify-content-center justify-content-md-between">
            <div class="contact-info d-flex align-items-center">
                <i class="bi bi-envelope d-flex align-items-center"><a href="tkaisyiyahlabuan@gmail.com">tkaisyiyahlabuan@gmail.com</a></i>
                <i class="bi bi-phone d-flex align-items-center ms-4"><span>+62 8912 3456 789</span></i>
            </div>
    ...
    <header id="header" class="d-flex align-items-center">
        <div class="container d-flex align-items-center justify-content-between">
            <div class="d-flex align-items-center">
                <a href="index.html" class="logo"><img src="assets/img/logo-tk.png" alt="" style="margin-right: 10px;"></a>
                <h1 class="logo" style="font-size: large;"><a href="index.html">Aisyiyah Bustanul Athfal <span>Labuan</span></a></h1>
            </div>
    ...
    <section id="hero" class="d-flex align-items-center">
        <div class="container" data-aos="zoom-out" data-aos-delay="100">
            <h1>Selamat Datang <span>Di</span></h1>
            <h2>TK Aisyiyah Bustanul Athfal Labuan</h2>
            <div class="d-flex">
                <a href="#profile" class="btn-get-started scrollto">Mulai jelajah</a>
            </div>
        </div>
    </section>
    <!-- End Hero -->
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 pt-4 pt-lg-0 content d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="100">
                        <h3>Sejarah Berdirinya Tk Aisyiyah Bustanul Athfal Labuan</h3>
                        <p class="fst-reguler">
                            Aisyiyah adalah organisasi perempuan muslim progresif yang sejak berdirinya pada tanggal 01 Juni tahun 1978 berdirilah
                            TK Aisyiyah Bustanul Athfal Labuan, yang bertempat tinggal di Kp. Pangusepan yang terletak tidak jauh dari pasar dan pantai Labuan.
                            TK Aisyiyah Bustanul Athfal Labuan didirikan oleh PCA Labuan, suatu Organisasi yang bergerak di bidang dakwah amar ma’ruf nahyi mungkar.
                        </p>
                        <ul>
                            <li>
                                <div>
